...
document.addEventListener('DOMContentLoaded', () => {
  ...
  handleForm('mainLeadForm', 'mainLeadSuccess', '✓ Acesso enviado! Bem-vindo à LogOS 1.0.');
  ...
  document.querySelectorAll('.btn-buy').forEach(btn => {
    btn.addEventListener('click', () => {
      const title = btn.dataset.title || 'Produto LogOS 1.0';
  ...
  const SHOP_PRODUCTS = [
    ...
    // ---- Treinamento: Ebooks ----
    { id: 'p110', cat: 'ebooks', brand: 'LogOS Academy', name: 'Ebook: Primeiros Passos na Tatuagem', price: 39, rating: 4.8, reviews: 210, desc: 'Guia completo pra quem está começando, da postura até o primeiro traço.' },
    { id: 'p111', cat: 'ebooks', brand: 'LogOS Academy', name: 'Ebook: Sombreado e Realismo', price: 49, rating: 4.6, reviews: 150, desc: 'Técnicas de sombreado progressivo pra quem já domina o traço.' },
